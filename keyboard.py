...
inst_button = InlineKeyboardButton(text="Опубликовать в Instagram", callback_data=f"publish_inst")


post_keyboard = InlineKeyboardMarkup(inline_keyboard=[[vk_button], [prepare_threads_button], [threads_button]])
post_keyboard_inst = InlineKeyboardMarkup(inline_keyboard=[[vk_button], [prepare_threads_button], [threads_button], [inst_button]])
